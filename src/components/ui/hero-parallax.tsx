...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[250vh] md:h-[250vh] xl:h-[310vh] 2xl:h-[250vh]    py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] "
    >
      <Header />
      <motion.div
        style={{
